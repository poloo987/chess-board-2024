...
public class FileReadEx1 {
    public static void main(String[] args) throws Exception {
        int userYN = JOptionPane.showConfirmDialog(null, "Is your file numeric ?");
        if(userYN == 0)
        {
...
//check to see if there is another record in the file
            System.out.println("--------------------------");
//hasNext() method will return true if there is more data, it returns a false if it is at the EOF
